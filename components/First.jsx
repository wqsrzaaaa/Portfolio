...
const FirstPage = () => {
  return (
    <>
      ...
      <div className='w-full flex items-end min-h-screen px-10'>
        <div className='md:w-[80%] select-none w-full min-h-120 gap-0 flex flex-col justify-center'>
          <h3 className='text-4xl'>Hello, I'm</h3>
          <h2 className='waqas font-extrabold'>Waqas Raza.</h2>
          <h1 className='text-4xl'>“I Transform Ideas into Interactive Solutions”</h1>
          <p className='mt-10'>
